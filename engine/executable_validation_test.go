...
func TestRunnerRunNodeLogicRejectsUnsupportedType(t *testing.T) {
	...
	_, err := r.runNodeLogic(models.Node{Type: "unknown"}, nil, nil, nil, nil, 0, "", context.Background(), 0)
...
func TestRunnerRecognizedBuiltInReachesRuntimeHandler(t *testing.T) {
	...
	_, err := r.runNodeLogic(models.Node{Type: models.NodeTypeSourceFile, Config: map[string]interface{}{}}, nil, nil, nil, nil, 0, "", context.Background(), 0)
	if err == nil {
