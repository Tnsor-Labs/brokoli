...
/** Types the engine can turn into a URI, i.e. that database, file and API nodes can actually use. */
export const USABLE_BY_NODES = new Set(['postgres', 'redshift', 'mysql', 'sqlite', 'mssql', 'snowflake', 'clickhouse', 'http', 'sftp', 's3'])
