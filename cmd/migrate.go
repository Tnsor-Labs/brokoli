...
Examples:
  ...
  brokoli migrate --from ./brokoli.db --to postgres://user:pass@host:5432/brokoli

  # PostgreSQL to SQLite
  brokoli migrate --from postgres://user:pass@host:5432/brokoli --to ./backup.db

  # Dry run (show counts, don't migrate)
  brokoli migrate --from ./brokoli.db --to postgres://... --dry-run`,
	RunE: runMigrate,
}
