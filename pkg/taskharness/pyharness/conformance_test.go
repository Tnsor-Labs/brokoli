...
func TestConformance(t *testing.T) {
	py := python3(t)
	conformance.Run(t, conformance.Python, func(t *testing.T, c conformance.Case) (taskharness.Result, []byte) {
		t.Helper()
		root, module := buildFixtureBundle(t, c.Source[conformance.Python])
